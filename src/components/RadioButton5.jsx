...
export default function RadioButton5({ text1, text2, text3, text4, text5 }) {
  return (
    <>
      <div className="flex flex-col pl-5 pt-3 mb-10">
        <div className={`${styles.radioinput}`}>
          <input value={text1} name="color" id="color-1" type="radio" />
        ...
        <div className={`${styles.radioinput}`}>
          <input value={text2} name="color" id="color-2" type="radio" />
        ...
        <div className={`${styles.radioinput}`}>
          <input value={text3} name="color" id="color-3" type="radio" />
        ...
        <div className={`${styles.radioinput}`}>
          <input value={text4} name="color" id="color-3" type="radio" />
          <label className="flex" htmlFor="color-3">
            <span className={styles.svg}>
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                <g strokeWidth="0" id="SVGRepo_bgCarrier"></g>
            ...
            <div className="self-center ml-8">{text4}</div>
          </label>
        </div>
        <div className={`${styles.radioinput}`}>
          <input value={text5} name="color" id="color-3" type="radio" />
          <label className="flex" htmlFor="color-3">
            <span className={styles.svg}>
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                <g strokeWidth="0" id="SVGRepo_bgCarrier"></g>
            ...
            <div className="self-center ml-8">{text5}</div>
          </label>
        </div>
      </div>
    </>
