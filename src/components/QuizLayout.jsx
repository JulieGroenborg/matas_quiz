    ...
    <div className="w-full flex flex-col place-content-center content-center bg-white rounded md:w-2/4">
      <header className="flex flex-col justify-items-center items-center">
        <div className={style.container}>
          <Image src={giftImage} alt="Gifts" width="fill" height="fill" priority className={`${style.image} pb-6`} />
          <svg className={style.close} xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="#FFFFFF" viewBox="0 0 16 16">
